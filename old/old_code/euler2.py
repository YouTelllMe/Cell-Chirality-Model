...
def plot_euler(euler_df):
    """
    Takes a vector dataframe with x, y, z columns and plots it (doesn't generate a figure, plot to 
    current axis)
    """
...
if __name__ == "__main__":
    ...
    A = 6.309078133216052 # A = t_final * d / c / l
    B = 0.037810656687541716 # B = t_final * k / c / l
    ...
    euler_df = euler(physics_system, np.array([-0.5,0.5,0.5, 0.5,0.5,0.5, -0.5,-0.5,0.5, 0.5,-0.5,0.5]), 1/N, tau, A, B, t_final)[0]
    animate(euler_df)
    plt.show()
