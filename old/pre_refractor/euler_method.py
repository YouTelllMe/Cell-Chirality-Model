import numpy as np
import pandas as pd
from models import model_AB, model_ABC
from euler_animate import animate
import matplotlib.pyplot as plt
import config
from typing import Callable

def run_euler(A: float, B: float, C: float) -> None:
    """
    Runs Euler method
    """
...
def euler(func: Callable, 
    ...
    for time in tau:
        ...
        curr_velocity = func(curr_pos, A, B, time, diag14, diag23, C)
...
if __name__ == "__main__":
    # run_euler(15.38832958,  0.08871743) #p2-cell, same cortical
    # run_euler(14.63467599,  0.08396541) #p2-cell, dif cortical
    # run_euler(6.83606058, 0.03953272) #no p2-cell, dif cortical (dunno which is which)
    # run_euler(6.73896785, 0.0400032) #no p2-cell, dif cortical (dunno which is which)
    # run_euler(9.24114813,  0.05898408, -0.67937048)
    # run_euler(9.51731785,  0.06418806, -0.51642482)
    # run_euler(13.19062768,  0.07815536) # positioned below
    run_euler(9.52521841,  0.06422443, -0.51578084)
