...
class FourCellFric:
    ...
    def get_velocity(self, t):
        ...
        cell1_prime = self.k * (-u12 * (distance12 - (1 + self.a *(0.6449**2 - (0.6449*t + 0.6449**2)*np.e**(-t/0.6449)))) 
                              - u14 * (distance14 - 1)) + self.c * cortical_flow_l * (np.cross(-u12, u24) - np.cross(u12, u13))

        cell2_prime = self.k * (u12 * (distance12 - (1 + self.a *(0.6449**2 - (0.6449*t + 0.6449**2)*np.e**(-t/0.6449)))) 
                              - u23 * (distance23 - 1)) + self.c * cortical_flow_r * (np.cross(u12, u13) - np.cross(-u12, u24))

        cell3_prime = self.k * (- u34 * (distance34 - (1 + self.a *(0.6449**2 - (0.6449*t + 0.6449**2)*np.e**(-t/0.6449)))) 
                                      + u23 * (distance23 - 1)) + self.c * cortical_flow_r * (np.cross(-u34, -u24) - np.cross(u34, -u13))

        cell4_prime = self.k * (u34 * (distance34 - (1 + self.a *(0.6449**2 - (0.6449*t + 0.6449**2)*np.e**(-t/0.6449)))) 
                              + u14 * (distance14 - 1)) + self.c * cortical_flow_l * (np.cross(u34, -u13) - np.cross(-u34, -u24))
...
if __name__ == "__main__":
    instance = FourCellFric([0.5, 0.5, 0, 0.5, -0.5, 0, 
                         -0.5, -0.5, 0, -0.5, 0.5, 0], 1, 2, 1000)
    instance.run()